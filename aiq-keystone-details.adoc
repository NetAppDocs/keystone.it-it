...
=== Ulteriori dettagli sulla protezione dei dati

.Fare clic qui
[%collapsible]
====
Se si è abbonati al servizio protezione dati (DP), è possibile visualizzare la disgregazione dei dati di consumo in base ai siti dei partner MetroCluster nella scheda *abbonamento Time Series*.
